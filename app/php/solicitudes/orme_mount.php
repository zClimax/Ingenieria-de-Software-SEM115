...
// 2) ID de solicitud (desde jefe_ver normalmente por GET)
$sid = (int)($_GET['id'] ?? 0);
if ($sid <= 0) {
...
if (strtoupper((string)$S['TIPO_DOCUMENTO']) !== 'ORME') {
  // No es de este tipo, no montamos nada.
  return;
}

// El firmante es el jefe del departamento aprobador
