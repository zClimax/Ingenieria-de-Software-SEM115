...
// ============================
// 3) Traer solicitud y validar tipo / depto aprobador
// ============================
$qSol = $pdo->prepare("
  SELECT ID_SOLICITUD,
         TIPO_DOCUMENTO,
...
if (strtoupper((string)$S['TIPO_DOCUMENTO']) !== 'TUT') {
...
// ============================
// 4) Normalizar datos para el form
// ============================
$sol = [
...
// ============================
// 5) Cargar formulario de captura
// ============================
require __DIR__ . '/tut_form.php';
